...
logger.info(f"🛰️  Initializing TiTiler extractor for NICFI collection {year}-{month}...")
...
predictor = ModelPredictor(
    ...
    upload_to_s3=True, # Upload predictions to cloud storage
    s3_path=f"predictions/{run_id}", # S3 path prefix
)
