...
export default {
  ...
  setup () {
    ...
    const benchmarkOptions = [
      { label: 'Choco Forest Watch 2022', value: 'nicfi-pred-northern_choco_test_2025_06_20-composite-2022' },
    ...
    const getDatasetKey = (value) => {
      ...
      if (value === 'nicfi-pred-northern_choco_test_2025_06_20-composite-2022') {
