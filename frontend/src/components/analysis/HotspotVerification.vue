            ...
            <q-card class="hotspot-list-card">
                <q-card-section>
                    ...
                    <div class="row items-center q-mb-md">
                        <q-input v-model.number="minAreaHa" type="number" label="Minimum Area (ha)" class="col" :rules="[
                            val => val >= 0 || 'Area must be positive',
                            val => val <= 1000 || 'Area must be less than 1000 ha'
                        ]">
                            <template v-slot:append>
                                <q-btn flat round dense icon="refresh" @click="loadHotspots"
                        ...
                        <div class="col-auto q-ml-md">
                            <q-btn flat dense color="primary" icon="download" @click="exportHotspots('all')">
                                <q-tooltip>Export All Hotspots</q-tooltip>
                            </q-btn>
                            <q-btn flat dense color="green" icon="download" @click="exportHotspots('verified')">
                                <q-tooltip>Export Verified Hotspots</q-tooltip>
                            </q-btn>
                            <q-btn flat dense color="info" icon="analytics" @click="showStats = true">
        ...
        <q-card class="q-dialog-plugin" style="width: 900px; max-width: 90vw;">
            ...
            <q-card-section class="bg-primary text-white">
                ...
                <div class="text-caption" v-if="selectedDeforestationMap">
                    Analysis Period: {{ selectedDeforestationMap.summary_statistics.prediction1_date }} to {{
                        selectedDeforestationMap.summary_statistics.prediction2_date }}
                </div>
            </q-card-section>
            ...
            <q-card-section class="q-pa-md">
                ...
                <div class="text-caption q-mt-md">
                    ...
                    Area percentages are calculated relative to the total AOI area of {{
